...
//        MasterViewController *controller = (MasterViewController *)navigationController.topViewController;
    ...
    //start uploading pending encounters
    self.sdsServices = [[SDSServices alloc]initWithDelegate:self];
    [self.sdsServices uploadEncounters];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Sana2_0" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Sana2_0.sqlite"];
...
#pragma mark - SDSServices Delegate Methods
